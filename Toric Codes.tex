...
\item Section \ref{Quantum mechanics} gives a treatment of the basics of quantum mechanics and quantum computation. In Subsection \ref{Quantum computing} the axioms of quantum mechanics are stated from a mathematical perspective, as well as ample motiation. Subsection \ref{Quantum computing} formally defines and describes quantum computation, with an emphasis on the information-theoretic language of computational complexity.

\item Section \ref{The Toric Code} gives a mathematical description of the toric code in terms of undergraduate-level linear algebra. While not strictly necessary, having taken a first course in Algebraic Topology would be preferable. For those unfamiliar with the subject, an introduction is given in Appendix \ref{Homology}. Those unfamiliar with the mathematical formalism of quantum mechanics are ad
vised to reference Appendix \ref{Quantum mechanics}, though the section is entirely readable without this background.
...
\caption{Celluation of the torus, obtained by gluing opposite sides together [WORK: add ``=donut" visual].}
\label{fig:torus}
\end{center}
\end{figure}
