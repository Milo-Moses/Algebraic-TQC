...
\begin{equation*}
\tikzfig{skein-relation} =  e^{3\pi i /5}\tikzfig{skein-identity} + e^{-3\pi i /5}\tikzfig{skein-fuse}
\end{equation*}

\begin{equation*}
\tikzfig{normalized-cups-and-caps}
\end{equation*}

\begin{equation*}
\tikzfig{fib-tri-up}\,\, ,\qquad \tikzfig{fib-tri-down}
\end{equation*}

\begin{equation*}
\tikzfig{fib-bubble} = \varphi \tikzfig{fib-identity}
\end{equation*}

\begin{equation*}
\tikzfig{skein-relation} =  e^{2\pi i /5}\tikzfig{fib-projector} + e^{-4\pi i /5}\tikzfig{skein-identity}
\end{equation*}
