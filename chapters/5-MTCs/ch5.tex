...
\Note{This section is a good time to talk a bit more about chirality. All quantum double modular categories are time-reversal symmetric, but there are time-reversal symmetric modular categories which are not quantum doubles. There should be an example in the anyon-data subsection.}
