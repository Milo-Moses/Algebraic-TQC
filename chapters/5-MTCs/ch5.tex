...
\begin{theorem}[\cite{farb2011primer}, Theorem 2.5] There is an isomorphism $\MCG(T^2)\cong \SL_2(\ZZ)$, which sends the element of $\MCG(T^2)$ represented by $\pi/2$-rotation to $s$,
