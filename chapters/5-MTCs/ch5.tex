...
\Note{There's another structure I would like to include - time reversal. Given a modular category $\cC$, define $\overline{\cC}$. Say that this corresponds to time reversal. I'm not sure if there's anything much to say. Somehow it feels natural for me to put this with the Deligne tensor product, but I think that's because I know about quantum double MTC... maybe there's a better place somewhere else.}
