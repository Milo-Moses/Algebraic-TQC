...
\begin{definition} A (finite-dimensional) Hilbert space $(V,\Braket{\cdot | \cdot})$ is the following data:
...
\item .[WORK: show that the adjoint really is the conjugate transpose]
\end{enumerate}

[WORK: I need to add somewhere that global phases don't matter, clear up this ambiguity]